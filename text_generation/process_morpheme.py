...
best_model_path = 'models/model_mp.pt'
...
def predTextMorpheme(text : str, num_words : int):
    t = [text]
    text2 = convert_to_morph(t)
    num_words = int(num_words)
    sample_data = data_process(text2)
    ...
    return t[0]+' '+revert_sentence(' '.join(pred_text))
