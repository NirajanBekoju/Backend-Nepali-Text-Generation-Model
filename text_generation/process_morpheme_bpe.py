...
tokenizer, vocab = getTokenizer(tokenizer_type = "morph_bpe")
ntokens = len(vocab)
...
best_model_path = 'models/model_mp_bpe.pt'
...
def predTextMorphemeBPE(text0 : str, num_words : int):
    text = convert_to_morph([text0])
    ...
    return ''.join(text0)+revert_sentence(''.join(m))
