...
from .model_utils import preProcessText, getTokenizer, word_piece_decoder, word_piece_encoder
...
best_model_path = 'models/model_word_piece.pt'
...
def predTextWordPiece(text : str, num_words : int):
    text = [text]
    ...
    return word_piece_decoder(' '.join(text)+ ' ' +' '.join(m))
